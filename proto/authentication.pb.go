...
func (x *AutInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutInput) ProtoMessage() {}

func (x *AutInput) ProtoReflect() protoreflect.Message {
	mi := &file_proto_authentication_proto_msgTypes[0]
...
// Deprecated: Use AutInput.ProtoReflect.Descriptor instead.
func (*AutInput) Descriptor() ([]byte, []int) {
	return file_proto_authentication_proto_rawDescGZIP(), []int{0}
}

func (x *AutInput) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *AutInput) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *AutOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutOutput) ProtoMessage() {}

func (x *AutOutput) ProtoReflect() protoreflect.Message {
	mi := &file_proto_authentication_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AutOutput.ProtoReflect.Descriptor instead.
func (*AutOutput) Descriptor() ([]byte, []int) {
	return file_proto_authentication_proto_rawDescGZIP(), []int{1}
}

func (x *AutOutput) GetSuccessStatus() int32 {
	if x != nil {
...
func (x *AutOutput) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_proto_authentication_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x3a, 0x0a, 0x08, 0x41, 0x75, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12,
	...
	,
}
...
var file_proto_authentication_proto_goTypes = []interface{}{
	(*AutInput)(nil),  // 0: proto.AutInput
	(*AutOutput)(nil), // 1: proto.AutOutput
}
var file_proto_authentication_proto_depIdxs = []int32{
	0, // 0: proto.Authentication.Authenticate:input_type -> proto.AutInput
	1, // 1: proto.Authentication.Authenticate:output_type -> proto.AutOutput
